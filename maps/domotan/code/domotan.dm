/datum/map/domotan
	...
	station_short = "Domotan"
	dock_name = "the Docks Mortimer"
	dock_short = "harbor"
	boss_name = "Etgard Keep"
	boss_short = "Etgard"
	company_name = "Court of Etgard"
	company_short = "Court"
	station_type = "island"//lmao

	command_spawn_enabled = TRUE
	command_spawn_message = "Welcome to Domotan Island!"
	...
	// shuttle_docked_message = "The Speaking Tower cries to all upon Domotan! Castle Etgard shall re-ignite the Mana Barrier in %ETA%. Matters of non-trivial nature will be delayed if outside the Town's barrier til dawn rises."
	// shuttle_leaving_dock = "The Speaking Tower drones on... The ignition has completed, and the Mana Barrier shall erupt to circle Domotan within %ETA%."
	// shuttle_called_message = "The Speaking Tower iterates suddenly, reverberating to all upon Domotan. The Mana Barrier has begun to rise, and the open port shall close within %ETA%."
	// shuttle_recall_message = "Halting! Halting! The Speaking Tower repeats. The Mana Barrier has been deactivated with willing intent! The port shall remain open 'til its rise again."
