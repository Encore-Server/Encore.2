...
job-description-borg = Half-human, Half-machine. Follow your laws, serve the crew, and hound the research team for upgrades.
...
job-description-rd = Manage the research department, unlocking technologies, acquiring & researching artifacts, and performing experiments.
...
job-description-roboticist = Build a makeshift workshop in research closet and create your own cyborg army.
